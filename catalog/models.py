...
from lib.db.fields import UpperCaseCharField
from lib.db.models import AuditableModel
...
class ProductAttributeValue(models.Model):
    ...
    value_option = models.ForeignKey(OptionGroupValue, models.PROTECT, null=True, blank=True)
...
class ProductImage(models.Model):
    ...
    image = models.ForeignKey("gallery.Image", on_delete=models.PROTECT)
